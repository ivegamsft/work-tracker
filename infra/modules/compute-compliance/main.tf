...
locals {
  ...
  service_key = "compliance"
  api_modules = "qualifications, medical, templates"
...
# Future: Will create dedicated azurerm_container_app resource for compliance services
# Service group: qualifications, medical, templates
...
# --- Future: dedicated Container App for compliance service ---
# resource "azurerm_container_app" "compliance" {
