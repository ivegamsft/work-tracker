...
locals {
  ...
  service_key = "reference"
  api_modules = "standards, labels"
...
# Future: Will create dedicated azurerm_container_app resource for reference services
# Service group: standards, labels
...
# --- Future: dedicated Container App for reference service ---
# resource "azurerm_container_app" "reference" {
