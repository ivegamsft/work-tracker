...
# Future: Will create dedicated azurerm_container_app resource for records services
# Service group: documents, hours
...
# --- Future: dedicated Container App for records service ---
# resource "azurerm_container_app" "records" {
